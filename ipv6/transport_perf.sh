...
do
LOCAL_ADDR=2001::192:168:21$i:11
REMOTE_ADDR=2001::192:168:21$i:12

ip addr add $LOCAL_ADDR/112 dev $LOCAL_NIC_PF

ssh $REMOTE_SERVER /bin/bash << EOF
	set -x #echo on
	ip addr add $REMOTE_ADDR/112 dev $REMOTE_NIC_PF
EOF
