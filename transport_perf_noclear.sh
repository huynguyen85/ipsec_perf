...
do
LOCAL_ADDR=192.$SECOND_OCTET.$i.64
REMOTE_ADDR=192.$SECOND_OCTET.$i.65
...
./setup_xfrm.sh -$OPTION -a -256 -v $LOCAL_ADDR/24 $LOCAL_NIC_PF $REMOTE_ADDR/24 $REMOTE_NIC_PF $REMOTE_SERVER $LOCAL_ADDR $REMOTE_ADDR
done
